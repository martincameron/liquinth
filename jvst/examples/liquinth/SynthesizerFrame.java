...
public class SynthesizerFrame extends JFrame {
	...
	public SynthesizerFrame( Synthesizer synthesizer ) {
		synthesizerPanel = new SynthesizerPanel( synthesizer );
	...
	private class LoadPatchMenuItemListener implements ActionListener {
		public void actionPerformed( ActionEvent event ) {
			int result = loadPatchFileChooser.showOpenDialog( SynthesizerFrame.this );
			if( result == JFileChooser.APPROVE_OPTION ) {
				try {
					...
					JOptionPane.showMessageDialog( SynthesizerFrame.this,
	...
	private class SavePatchMenuItemListener implements ActionListener {
		public void actionPerformed( ActionEvent event ) {
			int result = savePatchFileChooser.showSaveDialog( SynthesizerFrame.this );
			if( result == JFileChooser.APPROVE_OPTION ) {
				try {
	...
	private class SaveWaveMenuItemListener implements ActionListener {
		public void actionPerformed( ActionEvent event ) {
			...
			int result = saveWaveFileChooser.showSaveDialog( SynthesizerFrame.this );
			if( result == JFileChooser.APPROVE_OPTION ) {
				try {
